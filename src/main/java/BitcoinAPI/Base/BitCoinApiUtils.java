...
public class BitCoinApiUtils
{
    ...
    {
        return getInstance_ExchangeAPI().Ratio(EnumReigonType.USD, EnumReigonType.KRW) * usdValue;
    }

    public static double UsdToCny(double usdValue) throws Exception
    {
        return getInstance_ExchangeAPI().Ratio(EnumReigonType.USD, EnumReigonType.CNY) * usdValue;
    }

    public static double KrwToUsd(double krwValue) throws Exception
    {
        return getInstance_ExchangeAPI().Ratio(EnumReigonType.KRW, EnumReigonType.USD) * krwValue;
    }

    public static double KrwToCny(double krwValue) throws Exception
    {
        return getInstance_ExchangeAPI().Ratio(EnumReigonType.KRW, EnumReigonType.CNY) * krwValue;
    }

    public static double CnyToUsd(double krwValue) throws Exception
    {
        return getInstance_ExchangeAPI().Ratio(EnumReigonType.CNY, EnumReigonType.USD) * krwValue;
    }
    
    public static double CnyToKrw(double krwValue) throws Exception
    {
        return getInstance_ExchangeAPI().Ratio(EnumReigonType.CNY, EnumReigonType.KRW) * krwValue;
    }
};