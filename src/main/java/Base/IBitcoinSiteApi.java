...
public abstract class IBitcoinSiteApi
{
    ...
    {
        cachedInfo = new CoinInfo[6];

        cachedInfo[0] = new CoinInfo();
        cachedInfo[1] = new CoinInfo();
        cachedInfo[2] = new CoinInfo();
        cachedInfo[3] = new CoinInfo();
        cachedInfo[4] = new CoinInfo();
        cachedInfo[5] = new CoinInfo();
    }
